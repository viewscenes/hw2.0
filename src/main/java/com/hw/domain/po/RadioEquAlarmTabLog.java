...
public class RadioEquAlarmTabLog   implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "RadioEquAlarmTabLog";
	public static final String ALIAS_HEAD_CODE = "前端code";
	public static final String ALIAS_STATE00_COUNT = "当前报警未处理次数";
	public static final String ALIAS_REAL_ROW_COUNT = "总共报警次数";
    ...
    /**
     * 当前报警未处理次数       db_column: STATE00_COUNT 
     */	
	
	private Long state00Count;
    /**
     * 总共报警次数       db_column: REAL_ROW_COUNT 
     */	
	
	private Long realRowCount;
	//columns END

	public RadioEquAlarmTabLog(){
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof RadioEquAlarmTabLog == false) return false;
		if(this == obj) return true;
		RadioEquAlarmTabLog other = (RadioEquAlarmTabLog)obj;
